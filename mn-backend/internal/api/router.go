...
func SetupRouter() *gin.Engine {
	...
	adminService := service.NewAdminService(userRepo, tripRepo, favoriteRepo, adminRepo)
	...
	adminAdminController := controller.NewAdminAdminController(adminService)
	...
	{
		adminProtectedGroup.POST("/admins", adminAdminController.Create)
